...
public class ActivitiUtils {
     ...
     */
    public static String getFlowImgByInstanceId(String processInstanceId) throws Exception {
        ...
        InputStream imageStream = processDiagramGenerator.generateDiagram(bpmnModel, "jpg", highLightedActivitiIds, highLightedFlowIds, "宋体", "微软雅黑", "黑体", null, 2.0);
