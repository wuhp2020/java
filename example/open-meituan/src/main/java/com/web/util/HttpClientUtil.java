...
public class HttpClientUtil {
    ...
    public static String httpPostUrlEncoded(String url, Object obj) {
        HttpPost httpPost = new HttpPost(url);
        Map<String, Object> paramMap = gson.fromJson(gson.toJson(obj), Map.class);
        List<BasicNameValuePair> basicNameValuePairs =
                Optional.ofNullable(paramMap)
                        ...
                        .stream()
                        .map(param -> {
                            BasicNameValuePair pair = new BasicNameValuePair(param, String.valueOf(paramMap.get(param)));
                            return pair;
