...
public class ReferenceController {
    ...
    public ResponseVO forceReference() {
        try {
            ...
            log.error("method:forceReference() 异常", e);
    ...
    public ResponseVO softReference() {
        try {
    ...
    public ResponseVO weakReference() {
        try {
    ...
    public ResponseVO phantomReference() {
        try {
