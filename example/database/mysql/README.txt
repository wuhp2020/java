...
备执行:
CHANGE MASTER TO MASTER_HOST='192.168.221.133',MASTER_USER='root',MASTER_PASSWORD='123',MASTER_LOG_FILE='mysql-bin.000002',MASTER_LOG_POS=903;
START SLAVE;
show slave status \G;
SHOW PROCESSLIST;
...
主执行:
CHANGE MASTER TO MASTER_HOST='192.168.221.131',MASTER_USER='root',MASTER_PASSWORD='123',MASTER_LOG_FILE='mysql-bin.000002',MASTER_LOG_POS=903;
START SLAVE;
show slave status \G;
SHOW PROCESSLIST;
