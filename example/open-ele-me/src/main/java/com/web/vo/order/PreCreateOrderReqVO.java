...
public class PreCreateOrderReqVO {
    ...
    @ApiModelProperty(value = "订单商品总金额", example = "1000")
    private long goods_total_amount_cent;

    @ApiModelProperty(value = "订单商品客户实际支付金额", example = "1000")
    private long goods_actual_amount_cent;

    @ApiModelProperty(value = "订单小费", example = "0")
    private long order_tip_amount_cent;

    @ApiModelProperty(value = "订单总重量", example = "1.2")
