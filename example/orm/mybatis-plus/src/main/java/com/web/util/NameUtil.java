...
public class NameUtil {
    ...
    public static String getChannelSourceName() {
        String[] channelSourceNames = {"饿了么", "美团外卖", "百度外卖三家主流平台", "订餐小秘书", "口碑外卖", "大众点评外卖", "到家美食会", "外卖超人", "点我吧"};
        Random random = new Random();
        int channelSourceName = random.nextInt(channelSourceNames.length);
        return channelSourceNames[channelSourceName];
    }

    public static String getDeliveryCompanyName() {
        String[] deliveryCompanyNames = {"德邦物流", "华宇物流", "龙邦物流", "优速物流", "中邮物流", "畅通物流", "传喜物流", "中铁物流", "飞康达物流", "安能物流", "百福东方物流", "百世快递", "大田物流", "恒路物流", "佳吉快运", "嘉里大通物流", "康力物流", "联昊通物流", "明亮物流", "圣安物流", "盛辉物流", "穗佳物流", "万象物流", "信丰物流", "远成物流"};
        Random random = new Random();
        int deliveryCompanyName = random.nextInt(deliveryCompanyNames.length);
        return deliveryCompanyNames[deliveryCompanyName];
    }
}
